...
values
  ...
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Tomi President', 'president', '33333333-3333-3333-3333-333333333333', 'NUN-PRES-001', 'president', 'complete'),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Amina Executive', 'executive', '33333333-3333-3333-3333-333333333333', 'NUN-EXEC-001', 'executive', 'complete'),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Daniel Advisor', 'advisor', null, null, 'advisor', 'complete'),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Ada Student', 'student', '33333333-3333-3333-3333-333333333333', 'NUN-STU-001', 'student', 'complete'),
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'Pending Student', 'student', null, 'NUN-STU-002', 'student', 'complete'),
  ('99999999-9999-9999-9999-999999999999', 'Dues Student', 'student', null, 'NUN-STU-003', 'student', 'complete')
...
with demo_role_history (
  ...
  values
    ...
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, null::public.app_role, 'president'::public.app_role, null::uuid, '33333333-3333-3333-3333-333333333333'::uuid, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 'Demo seed: president profile.'),
    ('cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid, null::public.app_role, 'executive'::public.app_role, null::uuid, '33333333-3333-3333-3333-333333333333'::uuid, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 'Demo seed: executive profile.')
)
...
values
  ('12121212-1212-1212-1212-121212121212', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Tomi President', 'NUN-PRES-001', 'president@nilehive.test', '08000000001', 'president', 'active'),
  ('13131313-1313-1313-1313-131313131313', '33333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Amina Executive', 'NUN-EXEC-001', 'executive@nilehive.test', '08000000002', 'executive', 'active'),
  ('14141414-1414-1414-1414-141414141414', '33333333-3333-3333-3333-333333333333', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Ada Student', 'NUN-STU-001', 'student@nilehive.test', '08000000003', 'member', 'active'),
  ('15151515-1515-1515-1515-151515151515', '33333333-3333-3333-3333-333333333333', '99999999-9999-9999-9999-999999999999', 'Dues Student', 'NUN-STU-003', 'dues.student@nilehive.test', '08000000004', 'member', 'inactive')
...
values
  ('50000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Draft Innovation Workshop', 'Draft planning notes for an innovation workshop.', '2026-06-12', '10:00', 'Innovation Lab', 'draft', 'Introduce students to rapid prototyping.', 'Workshop', 50, 120000, '[{"item":"Materials","quantity":1,"description":"Workshop supplies","amount":120000}]', '[{"name":"Amina Executive","student_id":"NUN-EXEC-001","phone_number":"08000000002","position":"Logistics Lead"}]', null, 0, null, null),
  ('50000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'AI Awareness Seminar', 'Seminar awaiting advisor review.', '2026-06-18', '11:00', 'LT A', 'pending_advisor_review', 'Help members understand responsible AI.', 'Seminar', 100, 250000, '[{"item":"Refreshments","quantity":100,"description":"Light snacks","amount":250000}]', '[{"name":"Amina Executive","student_id":"NUN-EXEC-001","phone_number":"08000000002","position":"Operations"}]', timezone('utc', now()), 0, null, null),
  ('50000000-0000-0000-0000-000000000003', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Startup Pitch Night', 'Proposal awaiting final Club Services review.', '2026-06-25', '16:00', 'Auditorium', 'pending_admin_review', 'Give student founders a pitching platform.', 'Pitch night', 150, 500000, '[{"item":"Venue setup","quantity":1,"description":"Stage and media","amount":500000}]', '[{"name":"Amina Executive","student_id":"NUN-EXEC-001","phone_number":"08000000002","position":"Executive Support"}]', timezone('utc', now()), 0, 'Recommended for final approval.', null),
  ('50000000-0000-0000-0000-000000000004', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Returned Hackathon Proposal', 'Returned proposal that needs clearer budget justification.', '2026-07-02', '09:00', 'Innovation Lab', 'advisor_rejected', 'Run a student hackathon.', 'Hackathon', 80, 800000, '[{"item":"Internet support","quantity":1,"description":"Dedicated bandwidth","amount":800000}]', '[{"name":"Amina Executive","student_id":"NUN-EXEC-001","phone_number":"08000000002","position":"Technical Lead"}]', timezone('utc', now()), 1, 'Please clarify budget items and expected outcomes.', null),
  ('50000000-0000-0000-0000-000000000005', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Completed Innovation Showcase', 'Approved and completed showcase with report submitted.', '2026-03-10', '13:00', 'Main Hall', 'approved', 'Showcase completed student innovation projects.', 'Innovation showcase', 120, 400000, '[{"item":"Media coverage","quantity":1,"description":"Photography and video","amount":400000}]', '[{"name":"Amina Executive","student_id":"NUN-EXEC-001","phone_number":"08000000002","position":"Media Lead"}]', timezone('utc', now()), 0, 'Approved by advisor.', 'Approved by Club Services.'),
  ('50000000-0000-0000-0000-000000000006', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Past Approved Event Missing Report', 'Approved event intentionally left without a report for dashboard demo.', '2026-03-20', '14:00', 'LT B', 'approved', 'Create a missing report prompt.', 'Community meetup', 70, 150000, '[{"item":"Refreshments","quantity":70,"description":"Snacks","amount":150000}]', '[{"name":"Amina Executive","student_id":"NUN-EXEC-001","phone_number":"08000000002","position":"Coordinator"}]', timezone('utc', now()), 0, 'Approved by advisor.', 'Approved by Club Services.')
on conflict (id) do update set
...
values
  ('60000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Confirm seminar logistics', 'Check venue, projector, and seating.', 'high', 'pending', '2026-06-15'),
  ('60000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Prepare social media captions', 'Draft announcement captions for approved events.', 'medium', 'in_progress', '2026-06-10'),
  ('60000000-0000-0000-0000-000000000003', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Submit attendance sheet', 'Upload the attendance summary after the showcase.', 'low', 'completed', '2026-03-11')
on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
...
values
  ('70000000-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', '14141414-1414-1414-1414-141414141414', 5000, '2025/2026', 'NIC-PAID-001', 'dues-receipts/33333333-3333-3333-3333-333333333333/eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee/demo-receipt.pdf', 'paid', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', timezone('utc', now()) - interval '10 days'),
  ('70000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333', '15151515-1515-1515-1515-151515151515', 5000, '2025/2026', 'NIC-SUBMITTED-001', 'dues-receipts/33333333-3333-3333-3333-333333333333/99999999-9999-9999-9999-999999999999/demo-receipt.pdf', 'submitted', null, null),
  ('70000000-0000-0000-0000-000000000003', '33333333-3333-3333-3333-333333333333', '13131313-1313-1313-1313-131313131313', 5000, '2025/2026', null, null, 'unpaid', null, null)
on conflict (id) do update set
...
values
  ('80000000-0000-0000-0000-000000000001', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-3333-3333-3333-333333333333', 'member', 'pending', 'I want to join the club.', null, null, null, null, null, null, null),
  ('80000000-0000-0000-0000-000000000002', '99999999-9999-9999-9999-999999999999', '33333333-3333-3333-3333-333333333333', 'member', 'approved_pending_dues', 'Request approved, dues pending.', 'Pay dues to become active.', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', timezone('utc', now()) - interval '3 days', '15151515-1515-1515-1515-151515151515', '70000000-0000-0000-0000-000000000002', 5000, '2025/2026'),
  ('80000000-0000-0000-0000-000000000003', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '33333333-3333-3333-3333-333333333333', 'member', 'active', 'Active member request.', 'Dues verified.', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', timezone('utc', now()) - interval '15 days', '14141414-1414-1414-1414-141414141414', '70000000-0000-0000-0000-000000000001', 5000, '2025/2026')
on conflict (id) do update set
  status = excluded.status,
...
values
  ...
  ('a0000000-0000-0000-0000-000000000002', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Nile Innovators weekly meeting', 'Executives and members should prepare updates for the weekly meeting.', 'club', 'normal', null),
  ('a0000000-0000-0000-0000-000000000003', '33333333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Executive task follow-up', 'Executives should update assigned task progress today.', 'role', 'high', 'executive')
on conflict (id) do update set
  title = excluded.title,
