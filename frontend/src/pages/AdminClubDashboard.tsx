  ...
  if (!tasks.length) {
    return (
      <div className="clb-empty">
        ...
        <p className="mt-1 text-sm text-muted-foreground">President-assigned tasks will appear here for Clubly oversight.</p>
      </div>
    );
  }
...
export default function AdminClubDashboard() {
  ...
  if (role !== "admin") {
    return (
      <div className="clb-screen">
        <ClublyPageHeader eyebrow="Clubly" title="Club dashboard" description="This club operations view is for Clubly admins." />
        <ClublyStateCard icon={Users} title="Club dashboard access is restricted" message="Only Clubly admins can inspect all-club progress." />
      </div>
    );
  }
  ...
  if (isError || !dashboard) {
    return (
      <div className="clb-screen">
        <ClublyPageHeader eyebrow="Clubly" title="Club dashboard" description="We could not load this club operations view." />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Read-only task visibility for Clubly oversight.</p>
          </CardHeader>
          <CardContent>
