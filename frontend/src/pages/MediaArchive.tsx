    ...
    return (
      <div className="clb-screen">
        <ClublyPageHeader
          ...
          description="Post-event reports are available to presidents, advisors, and Clubly admins."
        />
  ...
  return (
    <div className="clb-screen">
      <ClublyPageHeader
        eyebrow="Archive"
        title="Reports & Media Archive"
        description="Document completed events and keep a central Clubly record."
      />
