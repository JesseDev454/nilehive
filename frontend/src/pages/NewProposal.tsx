...
export default function NewProposal() {
  ...
  const [form, setForm] = useState({
    title: "", club: "", description: "", eventDate: "", file: null as File | null,
  });
        ...
        <CardContent className="p-6">
          {step === 0 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input id="club" placeholder="e.g. Computer Science Society"
          ...
          {step === 1 && (
            <div className="space-y-4">
              <div>
                ...
                <Textarea id="description" placeholder="Describe the event, its goals, and expected outcomes..."
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">Upload budget plans, venue requests, etc.</p>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="space-y-4">
              <div>
                ...
                <Input id="date" type="date" value={form.eventDate}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="font-medium">{form.club || "—"}</span>
                </div>
                <div className="flex justify-between py-2 border-b">
          ...
          <div className="flex justify-between mt-6">
            ...
            {step < steps.length - 1 ? (
              ...
              <Button onClick={submit} className="bg-secondary hover:bg-secondary/90 text-secondary-foreground">
                Submit Proposal
              </Button>
            )}
          </div>
