...
export function BrandLogo({
  ...
  if (compact) {
    return (
      <div
        className={cn(
          "flex items-center justify-center overflow-hidden rounded-2xl border border-border bg-white shadow-soft-sm",
          compactSizes[size],
          className
        )}
      >
  ...
  return (
    <div
      className={cn(
        ...
        variant === "framed"
          ? "rounded-2xl border border-border bg-white shadow-soft-sm"
