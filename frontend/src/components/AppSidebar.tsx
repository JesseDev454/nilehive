...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border/10 bg-sidebar/75 backdrop-blur-xl max-[920px]:hidden">
      <SidebarHeader className={collapsed ? "border-b border-sidebar-border/10 px-1 py-5" : "border-b-0 p-5 pb-4"}>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-medium leading-6 text-sidebar-foreground/60">Clubly workspace</p>
                </div>
              </div>
              <button
                type="button"
                aria-label="Collapse sidebar"
                className="mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-[12px] text-sidebar-foreground/55 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
        ...
        {collapsed && (
          <button
            ...
            className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-[14px] bg-primary text-primary-foreground shadow-soft-sm"
      ...
      <SidebarFooter className={collapsed ? "border-t border-sidebar-border/10 px-1 py-3" : "mt-auto border-t border-sidebar-border/10 p-5"}>
        {collapsed ? (
