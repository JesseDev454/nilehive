...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border-2 px-2.5 py-1 text-[11px] font-black uppercase tracking-[0.12em] transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
