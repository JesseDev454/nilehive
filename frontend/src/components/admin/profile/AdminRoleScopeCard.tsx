import { CheckCircle, Layers, Lock, ShieldCheck } from "lucide-react";
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-bold text-foreground">
              OneClub Governance Scope
            </h2>
            <p className="text-[11px] text-muted-foreground">
              Directorate-level permissions
            </p>
          </div>
        </div>
      ...
      <div className="space-y-3 text-xs pt-1">
        ...
        <div className="space-y-2 pt-1">
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
            {profile.authorities.map((auth) => (
              <div
                key={auth}
                className="flex items-center gap-2 rounded-lg border border-border/50 bg-background/50 p-2.5 text-xs text-foreground"
              >
        ...
        <div className="flex items-start gap-2 rounded-xl border border-border/70 bg-muted/30 p-3 text-[11px] text-muted-foreground leading-relaxed">
          ...
          <span>
            ...
            Role switching is disabled for authenticated Directorate administrators to uphold institutional auditing standards and governance compliance.
          </span>
        </div>
      </div>
    </div>
