...
interface ExecutiveThemeSelectorProps {
  onThemeChanged?: (theme: "light" | "dark") => void;
}

export function ExecutiveThemeSelector({ onThemeChanged }: ExecutiveThemeSelectorProps) {
    ...
    <Card className="border-border/80 bg-card shadow-xs">
      ...
      <CardContent className="pt-4 space-y-3 text-xs">
        <p className="text-muted-foreground text-[11px]">
          Select your visual interface appearance for the OneClub executive suite. Preferences persist across sessions.
        </p>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="text-left w-full space-y-0.5">
              ...
              <span className={`text-[10px] block ${theme === "light" ? "text-primary-foreground/80" : "text-muted-foreground"}`}>
          ...
          >
            ...
            <div className="text-left w-full space-y-0.5">
              ...
              <span className={`text-[10px] block ${theme === "dark" ? "text-primary-foreground/80" : "text-muted-foreground"}`}>
